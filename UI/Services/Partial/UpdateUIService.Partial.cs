...
public partial class UpdateUIService
{
    ...
    private void ChangeTabName()
    {
        ...
        MainWindowViewModel.Value.Tabs[2].DisplayName = XAML_Tab_InfoJson;
        MainWindowViewModel.Value.Tabs[3].DisplayName = XAML_Tab_LogAnalysis;
        MainWindowViewModel.Value.Tabs[4].DisplayName = XAML_Tab_Setting;
        MainWindowViewModel.Value.Tabs[5].DisplayName = XAML_Tab_About;
    }
