...
public sealed class MessageBoxService : IMessageBoxService
{
    ...
    public Task<MessageBoxResult> FormatWarningConfirmMessageBoxAsync(string message, params object[] args) =>
    ...
    public Task<MessageBoxResult> FormatNoticeConfirmMessageBoxAsync(string message, params object[] args) =>
    ...
    public Task<MessageBoxResult> FormatErrorMessageBoxAsync(string message, params object[] args) =>
    ...
    public Task<MessageBoxResult> FormatErrorMessageBoxOverlayAsync(string message, params object[] args) =>
    ...
    public Task<MessageBoxResult> FormatNoticeMessageBoxAsync(string message, params object[] args) =>
    ...
    public Task<MessageBoxResult> FormatSuccessMessageBoxAsync(string message, params object[] args) =>
    ...
    public Task<MessageBoxResult> FormatSuccessMessageBoxOverlayAsync(string message, params object[] args) =>
